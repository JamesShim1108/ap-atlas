...
function courseList(){pageTitle('Choose an AP course for lessons, vocabulary, and practice. AP World History is the first course available.');return `<div class="container">${crumb([['Home','/'],['']])}<div class="page-intro"><p class="eyebrow">Choose your starting point</p><h1>Your course. Your pace.</h1><p>Start with a topic, understand the connections, and test what you know.</p></div><div class="courses-list course-catalog">${courses.map(courseCard).join('')}</div></div>`;}
